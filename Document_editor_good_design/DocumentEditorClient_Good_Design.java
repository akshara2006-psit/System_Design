package Document_editor_good_design;
...
class FileStorage implements Persistence {
    ...
    public void save(String data) {
        try {
            FileWriter outFile = new FileWriter("document_good.txt");
            outFile.write(data);
            outFile.close();
...
public class DocumentEditorClient_Good_Design {
...
// This is Good level design and it did not violate any of the principle it clearly follows every rule and bottom up approach is followed