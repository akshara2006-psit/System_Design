package document_edit_bad_design;
...
// Knowledge
// In this all the functionalities are within one class which violate the 
// 1- Single responsibility Principle
// 2- Open Closed Principle
// 3- Since there is only single class so liskov substitution principle, Interface Sgregation Principle, and Dependency Inversion Principle is not even followed in this
